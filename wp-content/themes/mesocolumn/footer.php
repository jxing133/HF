...
<script>
	jQuery(document).ready(function($) {
		...
		$('.commentNumber').prepend('Comment:');
		$('.commentNumber').prepend('<i class="fa fa-comment"></li>')
		$('.dateSpan').prepend('<i class="fa fa-clock-o"></li>')
		$('.authorSpan').prepend('<i class="fa fa-user"></li>')
